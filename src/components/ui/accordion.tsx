...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        {children}
        <Plus size={16} color="#141B34" className="shrink-0 transition-transform duration-200 group-data-[state=open]:hidden" />
        <Minus size={16} color="#141B34" className="shrink-0 transition-transform duration-200 group-data-[state=closed]:hidden" />
      </AccordionPrimitive.Trigger>
